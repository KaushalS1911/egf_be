...
async function forgotPassword(req, res) {
    ...
    try {
        ...
        const resetLink = `https://your-domain.com/reset-password/${token}`;
        ...
        const mailPayload = { subject: "Forgot Password", logo: logoPath, email: user.email };
...
async function resetPassword(req, res) {
    ...
    try {
        ...
        console.error(error);
        return res.status(500).json({ message: 'Server error or token expired.' });
    }
}

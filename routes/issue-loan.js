...
const {issueLoan, getAllLoans, updateLoan, getSingleLoan ,deleteMultipleLoans, disburseLoan,interestPayment} = require('../controllers/issue-loan')
...
router.put('/interest-payment/:interestId', interestPayment);
